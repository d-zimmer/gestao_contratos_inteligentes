...
SECRET_KEY = 'django-insecure-v!o(6g=c7*dt*#-aizbp8x*t1r@q7dr2pi&r8oa!i17p_$as#p'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://gestaocontratosinteligentes-a3apaqfsc7b0abgh.brazilsouth-01.azurewebsites.net/streamlit"
]
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'p**lmonk3y',
        'HOST': 'gestaocontratosinteligentes.postgres.database.azure.com',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
        }
